...
class UsuarioServiceTest {
    ...
    void registrar_cuandoUsernameNoExiste_retornaTrue() {
        ...
        assertThat(usuarioService.registrar(request)).isTrue();
    ...
    void registrar_cuandoUsernameExiste_retornaFalse() {
        ...
        when(usuarioRepository.findByUsername("juantest")).thenAnswer(inv -> Optional.of(existente));
        assertThat(usuarioService.registrar(request)).isFalse();
