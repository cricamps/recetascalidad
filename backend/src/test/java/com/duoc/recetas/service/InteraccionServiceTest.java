...
class InteraccionServiceTest {
    ...
    void getComentariosPorRecetaRetornaLista() {
        ...
        when(comentarioRepository.findByRecetaIdOrderByFechaCreacionDesc(1L)).thenReturn(List.of(comentario));
    ...
    void getMediosPorRecetaRetornaLista() {
        when(medioRepository.findByRecetaIdOrderByFechaSubidaDesc(1L)).thenReturn(List.of());
