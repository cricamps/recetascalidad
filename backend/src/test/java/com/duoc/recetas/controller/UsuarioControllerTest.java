...
class UsuarioControllerTest {
    ...
    void mostrarRegistro_retornaVistaRegistro() {
        assertThat(usuarioController.mostrarRegistro(model)).isEqualTo("registro");
        verify(model).addAttribute(eq("registroRequest"), any(RegistroRequest.class));
    }

    @Test
    @DisplayName("procesarRegistro con datos válidos redirige a login")
    void procesarRegistro_datosValidos_redirigeLLogin() {
        ...
        assertThat(usuarioController.procesarRegistro(req, model)).isEqualTo("redirect:/login?registrado=true");
    }
    ...
    void procesarRegistro_usernameDuplicado_retornaRegistroConError() {
        ...
        assertThat(usuarioController.procesarRegistro(req, model)).isEqualTo("registro");
    ...
    void mostrarFormularioReceta_retornaVistaFormulario() {
        assertThat(usuarioController.mostrarFormularioReceta(model)).isEqualTo("nueva-receta");
    }
    ...
    private RegistroRequest buildRequest(String username, String password, String nombre, String correo) {
