...
public class DataInitializer implements CommandLineRunner {
    ...
    private void inicializarRecetas() {
        ...
        agregarReceta("Arroz Graneado", "Tradicional", "Chile", "Fácil", 25, true,
            ...
            "Una taza de arroz por dos de agua hirviendo. Se puede agregar zanahoria, pimentón, ajo, perejil u orégano. La sal no es opcional.",
        ...
        agregarReceta("Pollo Asado al Horno", "Tradicional", "Chile", "Fácil", 40, true,
            ...
            "Pollo aliñado puesto en fuente para horno por 40 minutos. Se puede tapar con papel aluminio para que no se seque.",
        ...
        agregarReceta("Pollo Guisado", "Tradicional", "Chile", "Fácil", 45, false,
            ...
            "Freír cebolla con pimentón y ajo, y sobre estas verduritas cocinar las presas de pollo con cerveza o vino.",
        ...
        agregarReceta("Plateada a la Olla", "Tradicional", "Chile", "Media", 180, true,
            ...
            "Sellar la plateada en aceite de oliva, agregar vino o cerveza y cocinar 2-3 horas a fuego bajo.",
        ...
        agregarReceta("Charquicán Sin Charqui", "Tradicional", "Chile", "Media", 65, true,
            ...
            "Freír carne con verduras ralladas, agregar papas y zapallo picados y cocinar a fuego bajo sin agua.",
            "300g carne molida|1 cebolla chica|Pimentón|Zanahoria|1 trozo de zapallo|5 papas|Choclo congelado|Sal y ajo",
            "Rallar cebolla, pimentón y zanahoria.|Freír con la carne molida.|Agregar papas y zapallo picados pequeños.|Cocinar a fuego bajo sin agua, revolviendo.|Agregar choclo a los 20 minutos.|Cocinar 1 hora total.");
        ...
        agregarReceta("Sopa de Choritos", "Marina", "Chile", "Media", 40, true,
            ...
            "Freír cebollines con pimentón, cocinar choritos en vino blanco, desconchar y espesar con harina y crema.",
        ...
        agregarReceta("Empanadas de Pino al Horno", "Tradicional", "Chile", "Difícil", 90, true,
            ...
            "Masa con mantequilla y cerveza, rellena con pino de carne. Dejar reposar 30 minutos antes de estirar.",
        ...
        agregarReceta("Pescado Rico al Horno", "Marina", "Chile", "Fácil", 20, false,
            ...
            "Cualquier pescado fileteado con aceite de oliva y alcáparras. Rápido y sabroso.",
        ...
        agregarReceta("Cazuela Casera", "Tradicional", "Chile", "Media", 60, true,
            ...
            "Presas de pollo o carne|Cebolla|Zanahoria|Zapallo|Papas|Porotos verdes|Choclo|Un puñado de arroz|Sal",
        ...
        agregarReceta("Leche Asada", "Postre", "Chile", "Media", 70, true,
            ...
            "1 litro de leche|6 huevos|3/4 taza de azúcar|1/2 taza azúcar para caramelo|2 cdas agua|Vainilla",
            "Batir huevos con azúcar, vainilla y leche.|Preparar caramelo rubio.|Volcar caramelo en molde.|Agregar el batido.|Hornear a baño maría 1 hora.|Está listo cuando está cuajado.");
        ...
        agregarReceta("Arroz con Leche", "Postre", "Chile", "Fácil", 30, true,
            ...
            "El azúcar se agrega solo cuando el arroz está cocido. Con yema y crema queda más rico.",
            "1 taza de arroz|1 litro de leche|1/2 taza azúcar|1 yema de huevo|Cucharadas de crema",
            "Lavar el arroz.|Calentar leche y agregar arroz.|Cocinar a fuego lento 20 minutos revolviendo.|Agregar azúcar.|Mezclar yema con leche fría y agregar.|Agregar crema y apagar.");

        System.out.println("✅ Recetas inicializadas en la base de datos.");
    }
